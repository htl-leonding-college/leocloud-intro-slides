...
image::02-quarkus-response-time.png[background, size=contain]

=== Docker

image::docker-dockerfile-image-container.png[width=1200]

=== Kanonische Architektur - Begriff

.Definition von Oxford Languages
image::02-definition-kanonisch.png[width="1200"]
...
[plantuml,pipeline-overview-vm,png]
----
include::plantuml/pipeline-overview-vm.puml[]
----

IMPORTANT: binaries sind intermediate-code-files vorzuziehen

[%notitle]
=== Why K8s

image::02-containers-solve-problems.jpeg[background, size=contain]
...
* kann man mehr als eine Anwendung deployen?
* Wie kann man mehrere Instanzen eines Pods erzeugen?
* Wie kann man mehrere Pods erzeugen, die dann auf eine zentrale db zugreifen?

[%notitle]
=== Why K8s

image::02-k8s-easy-in-production.jpg[background, size=contain]
